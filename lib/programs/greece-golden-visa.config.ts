...
export const greeceGoldenVisaConfig: ProgramConfig = {
  ...
  footnotes: [
    ...
    "GCS professional fee — tangible track: property consultancy (1.8% + VAT) + consulting & admin (4% of property value) + professional fee €3,500/adult + €2,000/child + disbursements €900. Intangible track: €15,000 main applicant + €1,200 per dependant. €7,000 deposit on engagement; balance due at application submission.",
